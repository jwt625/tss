...
\label{cha:spin_simulation}
        ...
        \begin{figure}[!h]
            \begin{minipage}[b]{0.4\textwidth}
                ...
                \caption{仿真所得磁场空间分布截面图以及文献\cite{Mark2013}中所示磁场空间分布截面图}
        ...
        \begin{figure}[!h]
            \begin{minipage}[b]{0.4\textwidth}
                ...
                \caption{仿真所得磁场在位于距金属上表面$0.1\mu m$处水平截线上的分布以及文献\cite{Bienfait2016}中所示磁场在位于距金属上表面$0.1\mu m$处水平截线上的分布}
        ...
        \label{sec:螺旋状电感与2_5d谐振腔与单个自旋的耦合}
            ...
            \begin{figure}[!h]
                \begin{minipage}[b]{0.4\textwidth}
                    ...
                    \caption{来自参考文献\cite{sarabi2017prospective}的2.5维谐振腔的设计。其中左图为右图中红色虚线部分的放大图。}
