...
\label{cha:ppms系统的常用操作}
    ...
    \section{更换样品} % (fold)
    \label{sec:更换样品}
        首先升温至室温，300K，从2K开始升温则需约30分钟。样品室升至常温后，样品室气压约为$20\sim 40$Torr。点击Chamber分面板的Vent/Seal，此时样品室气压将快速升至常压，约790Torr，此后即可取出样品杆。若取出样品杆时间较长，应插入空样品杆并点击Chamber分面板的Purge/Seal以使样品室处于较好的密封环境。
